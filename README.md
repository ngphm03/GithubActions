[![Run App NgaPham](https://github.com/ngphm03/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ngphm03/GithubActions/actions/workflows/run-app.yaml)
